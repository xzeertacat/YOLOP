...
_C.DATASET.DATAROOT = '/content/drive/MyDrive/Temp/datasets/datasets/images'       # the path of images folder
_C.DATASET.LABELROOT = '/content/drive/MyDrive/Temp/datasets/datasets/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/content/drive/MyDrive/Temp/datasets/datasets/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/content/drive/MyDrive/Temp/datasets/datasets/ll_seg_annotations'  
